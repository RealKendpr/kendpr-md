...
export function DialogMenu({
  ...
  return (
    <dialog
      ...
      ref={dialog}
      className="open:open-dialog fixed inset-0 w-3/4 max-w-(--breakpoint-xsm) rounded-2xl border border-neutral-300 bg-neutral-500 backdrop:bg-neutral-900 backdrop:bg-opacity-50 backdrop:backdrop-blur-md dark:border-neutral-700 dark:bg-neutral-900"
